...
thus changing the storage schema without a direct edit to the schema.

Each file should have a single default export representing a single version's
storage format, and no other exports.

These types should not be written as an `interface` due to some minor details of
